...
//                    updating the values of sharedPreferences when user clicks the save button
                    saveButton.setOnClickListener {
                        ...
                        sharedPreferences.edit().putString("Name",name_saved.editText?.text.toString()).apply()
                        sharedPreferences.edit().putString("Budget",budget_saved.editText?.text.toString()).apply()
                        sharedPreferences.edit().putString("Income",income_saved.editText?.text.toString()).apply()
